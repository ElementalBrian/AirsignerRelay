...
def pricing(asset, timestamp, url, endpoint_id, api_key):
    # print(asset, "length of asset:", len(asset))
    ...
    try:
        return data["rawValue"]["market_data"]["current_price"]['usd']#, timestamp
...
if __name__ == "__main__":
    ...
    for endpoint_id, beacons in beacons_and_endpoints.items():
        for beacon, asset in beacons.items():
            ...
            print(f'{asset}: {pricing(asset, timestamp, url, endpoint_id, api_key)}')
